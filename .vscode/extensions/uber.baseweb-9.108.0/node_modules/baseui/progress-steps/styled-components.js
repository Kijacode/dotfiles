...
var StyledContentTail = (0, _index.styled)('div', function (_ref9) {
  ...
  return _ref10 = {
    position: 'absolute'
  }, _defineProperty(_ref10, $theme.direction === 'rtl' ? 'right' : 'left', '7px'), _defineProperty(_ref10, "top", 0), _defineProperty(_ref10, "height", "calc(100% + ".concat($theme.sizing.scale500, ")")), _defineProperty(_ref10, "marginBottom", 0), _defineProperty(_ref10, "width", $theme.sizing.scale0), _defineProperty(_ref10, "marginTop", "calc(".concat(size, " + (").concat(font.lineHeight, " - ").concat(size, ") / 2)")), _defineProperty(_ref10, "display", 'inline-block'), _defineProperty(_ref10, "backgroundColor", currentColor), _ref10;
});
