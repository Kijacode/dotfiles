...
export default function TriangleLeft(props) {
  return React.createElement(ThemeContext.Consumer, null, theme => theme.icons && theme.icons.TriangleLeft ? React.createElement(theme.icons.TriangleLeft, _extends({
    title: "Triangle Left",
    viewBox: "0 0 24 24"
