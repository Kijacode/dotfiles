...
export default function ChevronRight(props) {
  return React.createElement(ThemeContext.Consumer, null, theme => theme.icons && theme.icons.ChevronRight ? React.createElement(theme.icons.ChevronRight, _extends({
    title: "Chevron Right",
    viewBox: "0 0 24 24"
