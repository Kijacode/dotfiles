...
export default function TriangleRight(props) {
  return React.createElement(ThemeContext.Consumer, null, theme => theme.icons && theme.icons.TriangleRight ? React.createElement(theme.icons.TriangleRight, _extends({
