...
export const Action = styled('span', props => {
  ...
  return {
    alignItems: 'center',
    [$theme.direction === 'rtl' ? 'borderBottomLeftRadius' : 'borderBottomRightRadius']: $theme.borders.useRoundedCorners ? $theme.borders.radius400 : 0,
    [$theme.direction === 'rtl' ? 'borderTopLeftRadius' : 'borderTopRightRadius']: $theme.borders.useRoundedCorners ? $theme.borders.radius400 : 0,
...
export const Root = styled('span', props => {
  ...
  return { ...font150,
    ...
    [$theme.direction === 'rtl' ? 'paddingLeft' : 'paddingRight']: $closeable ? null : scale500,
    outline: 'none',
