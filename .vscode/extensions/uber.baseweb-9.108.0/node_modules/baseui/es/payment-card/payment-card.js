...
class PaymentCard extends React.Component {
  ...
  render() {
    ...
    const [IconWrapper, iconWrapperProps] = getOverrides(overrides.IconWrapper, StyledIconWrapper);
    ...
    return React.createElement(ThemeContext.Consumer, null, theme => React.createElement(Input, _extends({
      ...
      onChange: e => {
        const [position, value] = getCaretPosition(e.target.value, this.props.value || '', e.target.selectionStart);
