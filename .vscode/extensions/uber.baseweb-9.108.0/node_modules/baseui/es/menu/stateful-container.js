...
export default class MenuStatefulContainer extends React.Component {
  constructor(...args) {
    ...
    _defineProperty(this, "handleItemClick", (activedescendantId, index, item, event) => {
    ...
    _defineProperty(this, "handleMouseEnter", (activedescendantId, index) => {
    ...
    _defineProperty(this, "getRequiredItemProps", (item, index) => {
      ...
      if (this.state.highlightedIndex === index && this.state.activedescendantId !== activedescendantId) {
        this.setState({
          activedescendantId
        });
      }
