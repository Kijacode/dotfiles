    ...
    value: function render() {
      ...
      return React.createElement(ThemeContext.Consumer, null, function (theme) {
        return React.createElement(LocaleContext.Consumer, null, function (locale) {
          ...
          }, labels && labels.prevButton ? labels.prevButton : locale.pagination.prev), React.createElement(DropdownContainer, dropdownContainerProps, React.createElement(Select, _extends({
            options: options,
            labelKey: "label",
            valueKey: "label",
