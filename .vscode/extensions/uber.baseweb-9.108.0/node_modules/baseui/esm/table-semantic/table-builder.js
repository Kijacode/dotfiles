...
function (_React$Component) {
  ...
  function TableBuilder() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(TableBuilder).apply(this, arguments));
  }
    ...
    value: function render() {
      ...
      function renderHeader(col, colIndex) {
        ...
        switch (col.id === sortColumn && sortOrder) {
          case 'ASC':
            sortIcon = React.createElement(SortAscIcon, sortAscIconProps);
            break;

          case 'DESC':
            sortIcon = React.createElement(SortDescIcon, sortDescIconProps);
            break;

          default:
            sortIcon = React.createElement(SortNoneIcon, sortNoneIconProps);
            break;
        }
      ...
      return React.createElement(Root, _extends({
        ...
        return renderHeader(col, colIndex);
